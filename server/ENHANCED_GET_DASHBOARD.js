// Enhanced getDashboard function with dynamic data aggregation
// Replace the existing getDashboard function (lines 394-459) with this code
...
exports.getDashboard = async (req, res) => {
    try {
        ...
        const jobsPrevious30Days = completedJ obsData.filter(j => j.completedDate && j.completedDate >= sixtyDaysAgo && j.completedDate < thirtyDaysAgo).length;
        ...
        res.status(200).json({
            ...
            data: {
                ...
                trends: { applications: appsTrend, completedJobs: jobsTrend },
